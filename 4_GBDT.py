...
params['train'] = 'C:/Users/shuimu666/Desktop/dataset/train_tiqu.csv'
params['test'] = 'C:/Users/shuimu666/Desktop/dataset/verify_tiqu.csv'
argvs = sys.argv
try:
    ...
    test_y = test[:, -1]
    test_x = test[:, :-1]
    clf = GradientBoostingClassifier(n_estimators=params['n_estimators'],learning_rate=params['learning_rate'],subsample=params['subsample'],loss=params['loss'],max_depth=params['max_depth'],min_samples_split=params['min_samples_split'],min_weight_fraction_leaf=params['min_weight_fraction_leaf'],min_samples_leaf=params['min_samples_leaf'],max_features=params['max_features'],max_leaf_nodes=params['max_leaf_nodes'],min_impurity_split=params['min_impurity_split'])
    clf.fit(train_x, train_y)
    joblib.dump(clf,r'C:/Users/shuimu666/Desktop/xunlianyanzheng/GBDTmodel.model')
